...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Edit Pertanyaan</a>
                        </li>
@endsection
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-green-haze">
                                        ...
                                        <span class="caption-subject bold uppercase"> Form Edit Pertanyaan</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body form">
                                    <form role="form" class="form-horizontal" method="post" action="/edit-question/{{ $question->id }}/{{$workmeeting->uuid}}">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="input-group select2-bootstrap-append">
                                                    ...
                                                    <div class="col-md-10">
                                                    <input type="text" size="100%" class="form-control" id="form_control_1" placeholder="Penanya" value="{{ $question->name }}  {{ $question->fraction }}" readonly="true">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">Tidak Bisa diubah</span>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="question" class="form-control" id="form_control_1" placeholder="Pertanyaan" value="{{ $question->question }}">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="answer" class="wysihtml5 form-control" rows="6" placeholder="Enter more text">{{ $question->answer }}</textarea>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                        </div>
