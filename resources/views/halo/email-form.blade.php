@extends('halo.master')
@section('title', 'Kirim Melalui Email' )
...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Kirim Melalui Email</a>
                        </li>
@endsection
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-green-haze">
                                        ...
                                        <span class="caption-subject bold uppercase"> Form Kirim Melalui Email</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body form">
                                    <form role="form" class="form-horizontal" method="post" action="/process-email/{{$workmeeting->uuid}}">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="input-group select2-bootstrap-append">
                                                    <select id="single-append-text" class="form-control select2-allow-clear" name="speakers_id[]" multiple="yes">
                                                        <option></option>
