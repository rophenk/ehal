@extends('halo.master')
@section('title', 'Email Pertanyaan Terkirim' )
...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Email Pertanyaan Terkirim</a>
                        </li>
@endsection
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="/question-list">
                                          <button id="sample_editable_1_new" class="btn sbold green"> Kirim Dokumen Pertanyaan yang Lain
