@extends('halo.master')
@section('title', 'Kirim Dokumen Jawaban Melalui Email' )
...
@section('breadcrumb')
                        ...
                        <li>
                            <a href="#" class="active">Kirim Dokumen Jawaban Melalui Email</a>
                        </li>
@endsection
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-green-haze">
                                        ...
                                        <span class="caption-subject bold uppercase"> Form Kirim Jawaban Melalui Email</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body form">
                                    <form role="form" class="form-horizontal" method="post" action="/process-email-answer/{{$workmeeting->uuid}}">
                                        <div class="form-body">
